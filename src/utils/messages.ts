export const MESSAGES = {
  NOT_RESULT: 'Não temos resultados',
  PUB_EXIST: 'Infelizmente esse boteco já existe',
  PUB_CODE_EXIST: 'Já existe um boteco com esse código',
  PUB_IMAGE_EXIST: 'Já existe um boteco com o mesmo nome de imagem',
